...
const badgeVariants = cva(
  "inline-flex items-center rounded-md px-2 py-0.5 pb-px min-h-[1.25rem] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase font-bold text-[11px] truncate tracking-tight",
  {
    variants: {
      variant: {
        default:
