-- Update trackedEntity table to use nanoid() instead of xid() for default ID
ALTER TABLE "trackedEntity" ALTER COLUMN "id" SET DEFAULT nanoid();

-- Update trackedActivity table to use nanoid() instead of xid() for default ID
ALTER TABLE "trackedActivity" ALTER COLUMN "id" SET DEFAULT nanoid();
