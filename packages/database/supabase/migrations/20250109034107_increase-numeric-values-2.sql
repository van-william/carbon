...
ALTER TABLE "salesOrderLine"
  ...
  DROP COLUMN IF EXISTS "quantityToInvoice",
  ALTER COLUMN "saleQuantity" TYPE NUMERIC(16,5),
  ALTER COLUMN "unitPrice" TYPE NUMERIC(16,5),
  ALTER COLUMN "setupPrice" TYPE NUMERIC(16,5),
  ALTER COLUMN "addOnCost" TYPE NUMERIC(16,5),
  ALTER COLUMN "shippingCost" TYPE NUMERIC(16,5),
  ALTER COLUMN "quantitySent" TYPE NUMERIC(16,5),
  ALTER COLUMN "quantityInvoiced" TYPE NUMERIC(16,5),
  ADD COLUMN "quantityToSend" NUMERIC(16,5) GENERATED ALWAYS AS (CASE WHEN "salesOrderLineType" = 'Comment' THEN 0 ELSE GREATEST(("saleQuantity" - "quantitySent"), 0) END) STORED,
  ADD COLUMN "quantityToInvoice" NUMERIC(16,5) GENERATED ALWAYS AS (CASE WHEN "salesOrderLineType" = 'Comment' THEN 0 ELSE GREATEST(("saleQuantity" - "quantityInvoiced"), 0) END) STORED,
...
ALTER TABLE "purchaseInvoiceLine" ALTER COLUMN "quantity" TYPE NUMERIC(16,5);
