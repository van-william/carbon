---
title: CarbonOS Principles
description: Simplicity, extensibility, openness, and productivity are the four principles that guide the development of CarbonOS.
---
