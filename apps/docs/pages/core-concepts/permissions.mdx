---
title: Permissions in CarbonOS
description: Conventions for permissions in CarbonOS
---
...
2. **Module permissions** - These are permissions that are specific to a module. They are stored in the `public.userPermission` table.
