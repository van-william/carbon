---
title: Getting started with CarbonOS
description: Carbon is a high-performance operating system for manufacturing
---
...
| Application     | URL                                                                                                                |
| --------------- | ------------------------------------------------------------------------------------------------------------------ |
| CarbonOS        | [http://localhost:3000](http://localhost:3000)                                                                     |
