  ...
  const onUpdate = useCallback(
    (
      ...
      fetcher.submit(formData, {
        method: "post",
        action: path.to.bulkUpdateNonConformance,
      });
    },
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={() =>
                    copyToClipboard(
                      window.location.origin + path.to.nonConformance(id)
                    )
                  }
                >
              ...
              <TooltipContent>
                <span>Copy link to non-conformance</span>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
              ...
              <TooltipContent>
                <span>Copy non-conformance unique identifier</span>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
              ...
              <TooltipContent>
                <span>Copy non-conformance number</span>
              </TooltipContent>
            </Tooltip>
          </HStack>
        </HStack>
...
export default NonConformanceProperties;
