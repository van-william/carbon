...
import { nonConformanceAssociationValidator } from "~/modules/quality/quality.models";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  const validation = await validator(
    nonConformanceAssociationValidator
  ).validate(formData);
  ...
  switch (type) {
    case "customers":
      ...
      if (customerError) {
        return json({
          success: false,
          message: "Failed to create non-conformance customer",
        });
      }
      break;
    case "suppliers":
      ...
      if (supplierError) {
        return json({
          success: false,
          message: "Failed to create non-conformance supplier",
        });
      }
      break;
    case "jobOperations":
      ...
      if (job.error) {
        ...
        return json({
          success: false,
          message: "Failed to create non-conformance job operation",
        });
      }
    ...
    case "purchaseOrderLines":
      ...
      if (purchaseOrder.error) {
        ...
        return json({
          success: false,
          message: "Failed to create non-conformance purchase order line",
        });
      }
    ...
    case "salesOrderLines":
      ...
      if (salesOrder.error) {
        ...
        return json({
          success: false,
          message: "Failed to create non-conformance sales order line",
        });
      }
    ...
    case "shipmentLines":
      ...
      if (shipment.error) {
        ...
        return json({
          success: false,
          message: "Failed to create non-conformance shipment line",
        });
      }
    ...
    case "receiptLines":
      ...
      if (receipt.error) {
        ...
        return json({
          success: false,
          message: "Failed to create non-conformance receipt line",
        });
      }
