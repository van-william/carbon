...
>(
  ...
  switch (operation.laborUnit) {
    case "Total Hours":
      laborDuration = (operation.laborTime ?? 0) * 3600000; // Convert hours to milliseconds
      break;
    case "Total Minutes":
      laborDuration = (operation.laborTime ?? 0) * 60000; // Convert minutes to milliseconds
      break;
    case "Hours/Piece":
      laborDuration =
  ...
  switch (operation.machineUnit) {
    case "Total Hours":
      machineDuration = (operation.machineTime ?? 0) * 3600000; // Convert hours to milliseconds
      break;
    case "Total Minutes":
      machineDuration = (operation.machineTime ?? 0) * 60000; // Convert minutes to milliseconds
      break;
    case "Hours/Piece":
      machineDuration =
