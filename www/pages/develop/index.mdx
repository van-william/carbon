...
We think being in business is hard enough, and we'd love it if we could help make it easier. That's why we've licensed Carbon ERP under the permissive [MIT](https://opensource.org/license/mit) license. This means that you can use Carbon ERP for free, and you can modify it to meet your needs.
