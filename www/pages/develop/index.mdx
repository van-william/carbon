...
import { Features } from "../../components/Home/components";

# Carbon ERP

<Features />

Carbon ERP is a high performance, [open-source](https://github.com/barbinbrad/carbon), single-tenant (incomplete) ERP written in Typescript with web standards. It allows customers, suppliers, and employees to share a common platform.
...
We think being in business is hard enough, and we'd love it if we could help make it easier. That's why we've licensed Carbon ERP under the permissive [Elastic](https://www.elastic.co/licensing/elastic-license) license. This means that you can use Carbon ERP for free, and you can modify it to meet your needs.
